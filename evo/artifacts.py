...
ANALYSIS_DIAGNOSTIC_PLAN = 'analysis.diagnostic_plans'
ANALYSIS_EVIDENCE_PACKET = 'analysis.evidence_packets'
ANALYSIS_SEMANTIC_REVIEWS = 'analysis.semantic_reviews'
ANALYSIS_PROBE_OBSERVATIONS = 'analysis.probe_observations'
ANALYSIS_DIAGNOSTIC_SIDECAR = 'analysis.diagnostic_sidecars'
...
PARTITION_SET_BY_ARTIFACT = MappingProxyType({
    ...
    ANALYSIS_DIAGNOSTIC_PLAN: EVAL_CASE_REQUESTS,
    ANALYSIS_EVIDENCE_PACKET: EVAL_CASE_REQUESTS,
    ANALYSIS_SEMANTIC_REVIEWS: EVAL_CASE_REQUESTS,
    ANALYSIS_PROBE_OBSERVATIONS: EVAL_CASE_REQUESTS,
    ANALYSIS_DIAGNOSTIC_SIDECAR: EVAL_CASE_REQUESTS,
