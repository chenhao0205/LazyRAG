...
import type { WorkflowUiTab, WidgetConfig, CompositePanelNode } from '../core/workflowModel';
...
interface Props {
  ...
  onPageBarPositionChange: (pos: WorkflowUiTab['composite_tab_position']) => void;
}
