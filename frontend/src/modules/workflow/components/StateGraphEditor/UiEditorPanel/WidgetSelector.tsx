...
import type { WidgetType } from '../core/workflowModel';
import { SLOT_COMPATIBLE_WIDGETS, SLOT_DEFAULT_WIDGET } from '../core/workflowModel';
...
export default function WidgetSelector({ slotType, cardinality, value, onChange, size = 'small' }: Props) {
  ...
  const WIDGET_LABELS: Record<WidgetType, string> = {
    ...
    'html-slide': t('selfEvolutionRun.widgetHtmlSlide'),
